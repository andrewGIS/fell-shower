  ...
  <v-container>
    <v-card :loading="loadingCard" :disabled="loadingCard" flat>
      ...
      <v-alert border="right" colored-border type="info" elevation="2">
        На данной странице представлены результаты предсказания модели. В
        названии слоя указаны даты первого и второго снимка, использованных при
        анализе. Слой предварительно отфильтрован с использованием маски облачности
      </v-alert>
    </v-card>
  </v-container>
</template>
