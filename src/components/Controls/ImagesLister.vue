<template>
  <v-container>
    <v-card flat>
      <v-card-title> Группы снимков доступные для анализа </v-card-title>
        <v-expansion-panels>
        ...
        >
          ...
          <v-alert
            ...
            elevation="2"
          >
            На данной странице представлены снимки со спутника Sentinel - 2, для которых можно запустить расчет маски облачности. Чтобы запустить модель для выявления нарушений лесного покрова выберите два снимка из одной группы. При запуске модели будет получен слой с изменениями
          </v-alert>
    </v-card>
  </v-container>
</template>
